...
dae::SpritePreset FoodComponent::m_GreenScore100{ false, 3, 2, 1.f, 2, 0 };
dae::SpritePreset FoodComponent::m_GreenScore200{ false, 3, 2, 1.f, 3, 0 };
dae::SpritePreset FoodComponent::m_BlueScore100{ false, 3, 2, 1.f, 4, 4 };
dae::SpritePreset FoodComponent::m_BlueScore200{ false, 3, 2, 1.f, 5, 0 };

FoodComponent::~FoodComponent()
{
	dae::EventQueue::GetInstance().AddEvent(dae::Event{"FoodCompDestroyed"});
}
