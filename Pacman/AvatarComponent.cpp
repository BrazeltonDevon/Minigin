...
dae::SpritePreset AvatarComponent::m_GreenWalking{ false, 6, 7, 0.1f, 0, 7 };
dae::SpritePreset AvatarComponent::m_GreenDamaged{ false, 6, 7, 0.1f, 14, 18 };
dae::SpritePreset AvatarComponent::m_BlueWalking{ false, 6, 7, 0.1f, 21, 28 };
dae::SpritePreset AvatarComponent::m_BlueDamaged{ false, 6, 7, 0.1f, 35, 39 };
